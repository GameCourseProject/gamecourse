 ...
 * @param obj
 */
export function buildView(obj: any): View {
  ...
  else if (type === ViewType.TABLE_ROW || type === ViewType.TABLE_HEADER_ROW) return ViewRow.fromDatabase(obj as ViewRowDatabase);
