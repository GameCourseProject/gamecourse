...
export class InputUrlComponent implements OnInit {
  ...
  @Input() minLengthErrorMessage?: string = 'URL size needs to be greater than or equal to ' + this.minLength;    // Message for minLength error
  @Input() maxLengthErrorMessage?: string = 'URL size needs to be smaller than or equal to ' + this.maxLength;    // Message for maxLength error
