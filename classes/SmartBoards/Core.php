...
class Core {
    ...
    public static function checkAccess($redirect = true) {
        ...
        $pendingInvites = static::$mainConfigDB->get('pending-invites');
        if ($pendingInvites != null && array_key_exists($username, $pendingInvites)) {
            $pendingInvite = $pendingInvites[$username];
            ...
            unset($pendingInvites[$username]);
            static::$mainConfigDB->set('pending-invites', $pendingInvites);
        }
