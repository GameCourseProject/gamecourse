...
class Dictionary
{
    ...
    public static function init(bool $setup = false)
    {
        ...
        self::registerFunction(null, 'filter', function ($collection, string $key, string $value, string $operation, int $courseId) {
            self::checkArray($collection, "collection", "filter()");

            self::evaluateKey($key, $collection, $courseId);
            $newCollectionVals = [];
        ...
        self::registerFunction(
            null,
            'sort',
            function ($collection = null, string $order = null, string $keys = null, int $courseId) {
        ...
        self::registerFunction("actions", 'showToolTip', function (string $templateName, $user, $params = [], $course) {
            returnself::popUpOrToolTip($templateName, $params, "showToolTip", $course, $user);
        ...
        self::registerFunction("actions", 'showPopUp', function (string $templateName, $user, $params, $course) {
            returnself::popUpOrToolTip($templateName, $params, "showPopUp", $course, $user);
        ...
        self::registerFunction(
            ...
            'studentNumber',
            function ($user) {
                return self::basicGetterFunction($user, "studentNumber");
            },
        ...
        self::registerFunction(
            'awards',
            'getAllAwards',
            function (int $courseId, int $user = null, string $type = null, string $moduleInstance = null, string $initialDate = null, string $finalDate = null, bool $activeUser = true, bool $activeItem = true) {
                return self::getAwardOrParticipationAux($courseId, $user, $type, $moduleInstance, $initialDate, $finalDate, [], "award", $activeUser, $activeItem);
            },
        ...
        self::registerFunction(
            ...
            function (int $courseId, int $user = null, string $type = null, int $rating = null, int $evaluator = null, string $initialDate = null, string $finalDate = null,  bool $activeUser = true, bool $activeItem = true) {
                $where = [];
                if ($rating !== null) {
                    $where["rating"] = $rating;
                }
                ...
                return self::getAwardOrParticipationAux($courseId, $user, $type, null, $initialDate, $finalDate, $where, "participation",  $activeUser, $activeItem);
            },
        ...
        self::registerFunction(
            ...
            function (int $courseId, int $user = null, string $type = null, string $desc = null, int $rating = null, int $evaluator = null, string $initialDate = null, string $finalDate = null, bool $activeUser = true, bool $activeItem = true) {
                $where = [];
                if ($rating !== null) {
                    $where["rating"] = (int) $rating;
                }
        ...
        self::registerFunction(
            'participations',
            'getPeerGrades',
            function (int $courseId, int $user = null, int $rating = null, int $evaluator = null, bool $activeUser = true, bool $activeItem = true) {
                $where = [];
                ...
                $allPeergradedPosts = self::getAwardOrParticipation($courseId, $user, $type, null, null, null, $where, "participation", $activeUser, $activeItem);
        ...
        self::registerFunction(
            ...
            function (int $courseId, int $user, string $forum, string $thread = null) {
                $table = "participation";
        ...
        self::registerFunction(
            ...
            function (int $courseId, int $user, string $skill) {
        ...
        self::registerFunction(
            ...
            function (int $courseId, int $user, string $type) {
                $table = "participation";
     ...
     */
    public static function registerFunction(?string $funcLib, string $funcName, $processFunc, string $description, ?string $returnType, string $returnName = null, string $refersToType = "object", string $refersToName = null, bool $init = false)
    {
        if ($funcLib) {
