 ...
 */
    ...
    const COOKBOOK_FOLDER = ROOT_PATH . '<COOKBOOK_FOLDER>';
    const USER_DATA_FOLDER = ROOT_PATH . '<USER_DATA_FOLDER>';
    const PAGES_DATA_FOLDER = ROOT_PATH . '<PAGES_DATA_FOLDER>';
    const CORE_TEMPLATES_DATA_FOLDER = ROOT_PATH . '<CORE_TEMPLATES_DATA_FOLDER>';
    const CUSTOM_TEMPLATES_DATA_FOLDER = ROOT_PATH . '<CUSTOM_TEMPLATES_DATA_FOLDER>';